            ...
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li class="<?php if(isset($active2)){echo $active2;}?>">
                        <a href="operadores.php"><i class="fa fa-ticket"></i> Operadores</a>
                    </li>

                     <li class="<?php if(isset($active2)){echo $active2;}?>">
                        <a href="checkbox.php"><i class="fa fa-ticket"></i> Tareas recurrentes</a>
                    </li>

                    <li class="<?php if(isset($active3)){echo $active3;}?>">
                        <a href="projects.php"><i class="fa fa-list-alt"></i> Plataforma</a>
                    </li>
